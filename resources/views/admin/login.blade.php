...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/public/dashboard/css/login.css') }}?v={{ time() }}">
</head>    
...
<body>
    ...
    <div id="login">
        <img src="{{ asset('/public/dashboard/images/logo.png') }}" alt="">
        <form @submit.prevent>
    ...
    <script src="{{ asset('/public/dashboard/js/login.js') }}?v={{ time() }}"></script>
