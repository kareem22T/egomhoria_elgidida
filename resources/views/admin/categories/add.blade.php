            ...
            <div class="w-100 mb-3 d-flex gap-4">
                ...
                <div class="w-25">
                    <div for="thumbnail" class="w-100 h-100 p-3 d-flex justify-content-center align-items-center form-control input" style="max-height: 170px;" @click="this.showImages = true">
                        <img :src="preview_img ? preview_img :'/elgomhoria/public/dashboard/images/add_image.svg'" id="preview" alt="img logo" style="width: 100%; max-width: 100%;object-fit: contain;height: 100%;">                                                
                    </div>
                </div>
            </div>
...
createApp({
  ...
  methods: {
    async add(category_translations, main_name, description, cat_type, main_cat_id, thumbnail) {
      ...
      try {
        const response = await axios.post(`/elgomhoria/admin/categories/add`, {
